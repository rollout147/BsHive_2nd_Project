...
<script type="text/javascript">
    ...
    const popupWindow = window.open('<c:url value="/mn/timePopup"/>', 'timePopup', 'width=650,height=800');
			...
			<form action="/mn/insertPage" method="post" name="frm" onsubmit="return chkValue()" enctype="multipart/form-data">
				<div class="insert_page_content">
					<div class="insert_page_select">
						<select name="olineoff_type" class="select_insert">
							<option value="-1">온/오프라인선택</option>
							<option value="5">오프라인</option>
						</select>
					</div>
					...
					<div class="insert_page_input_2">
					    ...
					    <div class="insert_page_time_box">
						    ...
						    <div class="input-container">
						        <label for="lctrmNumInput" class="input-label">강의실번호</label>
						        <input type="text" id="lctrmNumInput" name="lctrm_num" readonly>
						    </div>
					...
					<div class="insert_page_input_3">
					    ...
					    <div class="insert_numpeople">
						    <select name="pscp_nope" class="select_insert">
					    ...
					    <div class="insert_page_lctr_containers" id="lctr-containers">
						    <div class="insert_page_lctr_container1 insert_page_lctr_container">
						        <div class="insert_page_lctr_content">
						            <div class="input-container">
								        <label for="lctrmNumInput" class="input-label2">강의실번호</label>
								        <input type="text" id="lcrt_weeks" class="insert_page_lctr_input5" value="1" name="lctr_weeks[]" readonly>
								    </div>
						        ...
						        <textarea type="text" id="lcrt_plan" class="insert_page_input_textarea" name="lctr_plan[]" placeholder="강의계획을 작성해주세요."></textarea>
						    </div>
						</div>
					    <button type="button" class="insert_page_lctr_plus" onclick="addContainer()">추가하기</button>
					</div>
					<div class="but_submit">
						<button type="submit" id="submitBtn" class="butgo">완료하기</button>
						<button id="backBtn" class="butgo2" onclick="history.back()">목록으로</button>
					</div>
				</div>
			</form>	
		</div>
