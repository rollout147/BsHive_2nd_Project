...
<head>
	...
	<c:set var="fliegroup" value="${fliegroup}"></c:set>
</head>
<style>
    /* 전반적인 스타일 */
    body {
    ...
    <div class="content">
        ...
        <div>
            <c:forEach var="filePath" items="${filePath}">
                <a download="${filePath.dwnld_file_nm}" 
                   href="download?filePath=${filePath.file_path_nm}" type="media_type">
                   ${filePath.dwnld_file_nm} 다운로드 
                </a>
                <br>
            </c:forEach>
		</div>
