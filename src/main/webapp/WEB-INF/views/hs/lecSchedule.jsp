		...
		<div class="main">
			...
			<table class="lecInfo">
					...
					<tr>
						...
						<th>수강료</th>
						<td><fmt:formatNumber value="${hsLec.fnsh_cost}" type="number" pattern="#,###" />원</td>
					</tr>
			</table>
				...
				<c:forEach var="lctrWeek" items="${lctrWeek }">
					<tr>
						...
						<div class="form-group">
							<td>
								<div>
			            			<c:forEach var="filePath" items="${weekFilesMap[lctrWeek.lctr_weeks]}">
