	...
	<div class="header_container">
		...
		<nav>
			<ul class="header_menu_2">
				<li><a href="<%= request.getContextPath() %>/jh/introduceHiveProject">센터소개</a></li>
				<li><a href="<%= request.getContextPath() %>/mn/lctListPage">오프라인수강신청</a></li>
				<li><a href="<%= request.getContextPath() %>/se/onlnList">LMS</a></li>
				<li><a href="<%= request.getContextPath() %>/mh/gongList">고객센터</a></li>
			</ul>
		</nav>
                ...
                <c:when test="${not empty sessionScope.user }">
                    ...
                    <c:choose>
                        <c:when test="${sessionScope.user.mbr_se == 3 }">
                            <a href="/kh/admin/adminMain" class="lpgin_mypage_but"><img alt="관리자페이지" src="<%=request.getContextPath()%>/images/main/관리자.png" class="lpgin_but_img">&nbsp;관리자페이지</a>
                        </c:when>
                        <c:otherwise>
