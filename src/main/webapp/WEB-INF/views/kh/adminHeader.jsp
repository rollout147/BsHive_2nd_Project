...
<body>
	<header>
		<a href="/"><img	src="<%=request.getContextPath()%>/images/main/kh_Logo_.png" /></a>
		<div id="timerDiv">
			<span id="userId">사용자 : ${sessionScope.user.eml }</span>
			&nbsp;&nbsp;
			<button id="extentionButton"	type="button" onclick="goLogOut();">로그아웃</button>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
