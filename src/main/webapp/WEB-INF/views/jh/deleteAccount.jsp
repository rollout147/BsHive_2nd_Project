...
<div class="lctrList_main_banner">
		...
		<div class="lctrList_main_banner_text2">회원탈퇴</div>
...
<div class="body">
    <div class="main-container">
		...
		<div class="content">
		    ...
		    <div class="realPwChk">    
		        <form action="/jh/realDeleteAccount" method="post" id="loginForm" onsubmit="return confirmDeletion();">
