...
<div class="lctrList_main_banner">
		...
		<div class="lctrList_main_banner_text2">마이페이지</div>
		<img alt="메인배너" src="<%=request.getContextPath()%>/images/background/마이페이지.png" class="lctrList_main_banner_img">
</div>
<div class="body">
    <div class="main-container">
        ...
        <div class="content">
    		...
    		<form action="/jh/myWrittingList" method="get">
	            <div class="content-box" onclick="this.closest('form').submit();">
