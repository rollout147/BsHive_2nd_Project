...
<div class="body"> 
	...
	<a href="/jh/pwChk" class="link-style <%= request.getRequestURI().equals("/jh/pwChk") || request.getRequestURI().equals("/jh/realPwChk") ? "active" : "" %>">회원정보변경</a>
    ...
    <a href="/jh/myWrittingList" class="link-style <%= request.getRequestURI().equals("/jh/myWrittingList") ? "active" : "" %>">내가 등록한 글</a>
