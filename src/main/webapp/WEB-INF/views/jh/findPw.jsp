...
<div class="lctrList_main_banner">
		<div class="lctrList_main_banner_text3"><div class="lctrList_main_banner_do"></div><div class="title">로그인</div></div>
		<div class="lctrList_main_banner_text2">비밀번호 찾기</div>
		<img alt="메인배너" src="<%=request.getContextPath()%>/images/background/회원가입.png" class="lctrList_main_banner_img">
</div>	
	<div class="body">
