...
public class MhServiceImp implements MhService {
	...
	public int updateGong(Pst pst, List<File> fileList) {
		int updateGong = 0;
		updateGong = md.updateGong(pst, fileList);
		return updateGong;
	}
	...
	public List<File> getFilesByGroup(int file_group) {
		...
		getFilesByGroup = md.getFilesByGroup(file_group);
	...
	public File getFile(int fileGroup, int fileSeq) {
		File getFile = null;
		getFile = md.getFile(fileGroup, fileSeq);
		return getFile;
	}
	...
	public List<File> filePath(int file_group) {
		...
		filePath = md.filePath(file_group);
		return filePath;
	}
	...
	public int totaloneList1() {
		int totaloneList1=0;
		totaloneList1 = md.totaloneList1();
	...
	public int updateAnswr(Pst pst) {
		int updateAnswr =0;
		updateAnswr = md.updateAnswr(pst);
		return updateAnswr;
	}
	...
	public int deleteFile(Hs_Assignment assign) {
		int deleteFile = 0;
		deleteFile = md.deleteFile(assign);
		return deleteFile;
	}
